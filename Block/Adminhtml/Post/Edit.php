<?php
namespace Skywire\Blog\Block\Adminhtml\Post;
    ...
    extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Skywire_Blog';
        $this->_controller = 'adminhtml_post';

        parent::_construct();

        if ($this->_isAllowedAction('Skywire_Blog::save')) {
        ...
        if ($this->_isAllowedAction('Skywire_Blog::post_delete')) {
